...
public class SpeechBubble : MonoBehaviour
{
    ...
    //Should the bubble be enabled?
    public bool bubble_enabled = true;
    ...
    void OnGUI()
    {
        ...
        Texture2D texture = new Texture2D(bubbleWidth, bubbleHeight);
        ...
        texture.Apply();
        GUI.Label(new Rect(0, 0, 200, 100), texture);

        //Render the text  
        GUI.Label(new Rect(10, 25, 190, 50), "Help me! Please put out my fire, save my friends and take care of the robbers!", guiSkin.label);

        //If the button is pressed, go back to 41 Post  
        if (GUI.Button(new Rect(50, 60, 80, 20), "OK"))
        {
